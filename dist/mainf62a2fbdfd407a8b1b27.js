...
/* harmony export */   "getEducationInformation": () => (/* binding */ getEducationInformation),
/* harmony export */   "getImages": () => (/* binding */ getImages),
/* harmony export */   "getLgbtqInformation": () => (/* binding */ getLgbtqInformation),
/* harmony export */   "getLivingInformation": () => (/* binding */ getLivingInformation),
/* harmony export */   "getPollutionInformation": () => (/* binding */ getPollutionInformation),
/* harmony export */   "getSalaries": () => (/* binding */ getSalaries),
...
var apiUrl = "https://api.teleport.org/api/urban_areas/slug:";
var input = document.getElementById("searchBar");
var summary = document.getElementById('display-summary');
var pictures = document.getElementById('display-image');
var salaries = document.getElementById("display-salaries");
...
function _getSummary() {
  _getSummary = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, summaryData;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("".concat(apiUrl).concat(input.value, "/scores/"));
        case 3:
          response = _context.sent;
          summaryData = response.data.summary;
          return _context.abrupt("return", summaryData);
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          errorHandling(_context.t0);
        case 11:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          return _context2.abrupt("return", categoriesData);
        case 8:
          _context2.prev = 8;
...
function _getImages() {
  _getImages = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("".concat(apiUrl) + "".concat(input.value, "/images/"));
        case 3:
          response = _context3.sent;
          imageUrl = response.data.photos[0].image.web;
          return _context3.abrupt("return", imageUrl);
        case 8:
          _context3.prev = 8;
          _context3.t0 = _context3["catch"](0);
          errorHandling(_context3.t0);
        case 11:
        case "end":
...
;
getImages;
function getLgbtqInformation() {
  return _getLgbtqInformation.apply(this, arguments);
}
function _getLgbtqInformation() {
  _getLgbtqInformation = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var response, lgbtqData;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("".concat(apiUrl) + "".concat(input.value, "/details/"));
        case 3:
          response = _context4.sent;
          lgbtqData = response.data.categories["12"].data;
          return _context4.abrupt("return", lgbtqData);
        case 8:
          _context4.prev = 8;
          _context4.t0 = _context4["catch"](0);
          errorHandling(_context4.t0);
        case 11:
        case "end":
...
function getSalaries() {
  return _getSalaries.apply(this, arguments);
}
function _getSalaries() {
  _getSalaries = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    var response, salariesData;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _context5.next = 3;
          return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("".concat(apiUrl) + "".concat(input.value, "/salaries/"));
        case 3:
          response = _context5.sent;
          salariesData = response.data.salaries;
          return _context5.abrupt("return", salariesData);
        case 8:
          _context5.prev = 8;
          _context5.t0 = _context5["catch"](0);
          errorHandling(_context5.t0);
        case 11:
        case "end":
...
;
getSalaries;
function getPollutionInformation() {
  return _getPollutionInformation.apply(this, arguments);
}
function _getPollutionInformation() {
  _getPollutionInformation = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    var response, pollutionData;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 3:
          ...
          pollutionData = response.data.categories["15"].data;
          return _context6.abrupt("return", pollutionData);
        case 8:
          _context6.prev = 8;
          _context6.t0 = _context6["catch"](0);
          errorHandling(_context6.t0);
        case 11:
        case "end":
...
function getLivingInformation() {
  return _getLivingInformation.apply(this, arguments);
}
function _getLivingInformation() {
  _getLivingInformation = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
    var response, livingData;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 3:
          ...
          livingData = response.data.categories["3"].data;
          return _context7.abrupt("return", livingData);
        case 8:
          _context7.prev = 8;
          _context7.t0 = _context7["catch"](0);
          errorHandling(_context7.t0);
        case 11:
        case "end":
...
function getEducationInformation() {
  return _getEducationInformation.apply(this, arguments);
}
function _getEducationInformation() {
  _getEducationInformation = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
    var response, educationData;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 3:
          ...
          educationData = response.data.categories["6"].data;
          return _context8.abrupt("return", educationData);
        case 8:
          _context8.prev = 8;
          _context8.t0 = _context8["catch"](0);
          errorHandling(_context8.t0);
        case 11:
        case "end":
...
var displayInfo = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var responseSummary, image, LgbtqInformation, displayDataLgbtq, dataSalaries, displayDataSalaries, tableDiv, pollutionInformation, displayDataPollution, livingInfo, displayDataLiving, educationInfo, displayDataEducation, div;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return (0,_generate__WEBPACK_IMPORTED_MODULE_1__.getSummary)();
        case 2:
          ...
          _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
            var data, canvas, hasChart, chart, updateChart, _updateChart;
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                  _updateChart = function _updateChart3() {
                    _updateChart = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
                      var updatedData;
                      return _regeneratorRuntime().wrap(function _callee$(_context) {
                        while (1) switch (_context.prev = _context.next) {
                          case 0:
                            _context.next = 2;
                            return (0,_generate__WEBPACK_IMPORTED_MODULE_1__.getCategories)();
                          case 2:
                            updatedData = _context.sent;
                            chart.data.labels = updatedData.map(function (x) {
                              return x.name;
                            });
                            chart.data.datasets[0].data = updatedData.map(function (row) {
                              return row.score_out_of_10;
                            });
                            chart.update();
                          case 6:
                          case "end":
                  ...
                  updateChart = function _updateChart2() {
                    return _updateChart.apply(this, arguments);
                  };
                  _context2.next = 4;
                  return (0,_generate__WEBPACK_IMPORTED_MODULE_1__.getCategories)();
                case 4:
                  ...
                  canvas = document.getElementById('myChart'); // Check if the canvas element already has an associated graphic
                  hasChart = canvas.getAttribute('data-has-chart') === 'true'; // If a chart is already attached to the canvas, destroy it
                  if (hasChart) {
                    chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"].getChart(canvas).destroy();
                  }

                  // Create the new chart
                  chart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](canvas, {
                    type: 'bar',
                    options: {
                      responsive: true
                    },
                    data: {
                      ...
                      datasets: [{
                        ...
                        backgroundColor: data.map(function (color) {
                          return color.color;
                        })
                      }]
                    }
          ...
          _context3.next = 7;
          return (0,_generate__WEBPACK_IMPORTED_MODULE_1__.getImages)();
        case 7:
          ...
          _context3.next = 12;
          return (0,_generate__WEBPACK_IMPORTED_MODULE_1__.getLgbtqInformation)();
        case 12:
          LgbtqInformation = _context3.sent;
          displayDataLgbtq = LgbtqInformation === null || LgbtqInformation === void 0 ? void 0 : LgbtqInformation.map(function (object) {
            ...
            return "<div id=\"displayDataLgbtq\">\n <div class=\"row\">\n   <div class=\"col\">\n   ".concat(label, "\n   </div>\n   <div class=\"col\">\n   ").concat(string_value || percent_value || finalPercentValue, "\n   </div>\n </div>\n</div>");
          }).join('');
          _context3.next = 16;
          return (0,_generate__WEBPACK_IMPORTED_MODULE_1__.getSalaries)();
        case 16:
          dataSalaries = _context3.sent;
          ...
          tableDiv.innerHTML = "\n<div id=\"displayDataSalaries\" data-aos=\"fade-right\"\ndata-aos-offset=\"300\">\n <table class=\"table text-start\">\n  <thead>\n    <tr>\n      <th scope=\"col\">Job</th>\n      <th scope=\"col\">Salaries</th>\n    </tr>\n  </thead>\n  <tbody>\n  ".concat(displayDataSalaries, "\n    </tbody>\n    </table>");
          _context3.next = 24;
          return (0,_generate__WEBPACK_IMPORTED_MODULE_1__.getPollutionInformation)();
        case 24:
          pollutionInformation = _context3.sent;
          displayDataPollution = pollutionInformation === null || pollutionInformation === void 0 ? void 0 : pollutionInformation.map(function (object) {
            var label = object.label,
              float_value = object.float_value,
          ...
          _context3.next = 28;
          return (0,_generate__WEBPACK_IMPORTED_MODULE_1__.getLivingInformation)();
        case 28:
          livingInfo = _context3.sent;
          displayDataLiving = livingInfo === null || livingInfo === void 0 ? void 0 : livingInfo.map(function (object) {
            var label = object.label,
              currency_dollar_value = object.currency_dollar_value,
              float_value = object.float_value;
            //with this operation we transform a simple number
            //in decimal number (prices)
            var currencyDollar = currency_dollar_value;
            var costOfLiving = new Intl.NumberFormat('en-IN', {
              style: 'currency',
              currency: 'USD',
              currencyDisplay: 'narrowSymbol'
            }).format(currencyDollar);
            return "<div id=\"displayDataLiving\">\n   <div class=\"row\">\n     <div class=\"col\">\n     ".concat(label, "\n     </div>\n     <div class=\"col\">\n     ").concat(float_value || costOfLiving, "\n     </div>\n   </div>\n  </div>");
          }).join('');
          _context3.next = 32;
          return (0,_generate__WEBPACK_IMPORTED_MODULE_1__.getEducationInformation)();
        case 32:
          educationInfo = _context3.sent;
          displayDataEducation = educationInfo === null || educationInfo === void 0 ? void 0 : educationInfo.map(function (object) {
            var label = object.label,
              percent_value = object.percent_value,
              float_value = object.float_value,
              int_value = object.int_value,
              string_value = object.string_value;
            //with this operation I translate simple values ​​into percentages
            var percentValueNum = percent_value;
            var finalPercentValue = Number(percentValueNum / 100).toLocaleString(undefined, {
              style: 'percent',
              minimumFractionDigits: 2
            });
...
/******/ })()
;
//# sourceMappingURL=mainf62a2fbdfd407a8b1b27.js.map