...
function _getSummary() {
  _getSummary = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, errorHendling;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("".concat(apiUrl) + "".concat(search.value, "/scores/"));
        case 3:
          response = _context.sent;
          return _context.abrupt("return", response.data.summary);
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          errorHendling = function errorHendling() {
            if (search.value === "") {
              document.getElementById('errorMessage').innerHTML = "<div class=\"alert alert-danger\" role=\"alert\"> Type Los Angeles </div>" + _context.t0;
            }
          };
          ;
        case 11:
...
function _getImages() {
  _getImages = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var response, errorHendling;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("".concat(apiUrl) + "".concat(search.value, "/images/"));
        case 3:
          response = _context2.sent;
          return _context2.abrupt("return", response.data.photos[0].image.web);
        case 7:
          _context2.prev = 7;
          _context2.t0 = _context2["catch"](0);
          errorHendling = function errorHendling() {
            if (search.value === "") {
              document.getElementById('errorMessage').innerHTML = "<div class=\"alert alert-danger\" role=\"alert\"> Type Los Angeles </div>" + _context2.t0;
            }
          };
          ;
        case 11:
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          return _context3.abrupt("return", response.data.categories);
        case 7:
          _context3.prev = 7;
...
var okok = document.querySelector('#display-summary');
var ok2 = document.querySelector('#display');
...
var displayInfo = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var responseSummary, displayCategories, image, dataDisplay;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0,_generate__WEBPACK_IMPORTED_MODULE_0__.getSummary)();
        case 2:
          responseSummary = _context.sent;
          _context.next = 5;
          return (0,_generate__WEBPACK_IMPORTED_MODULE_0__.getCategories)();
        case 5:
          displayCategories = _context.sent;
          _context.next = 8;
          return (0,_generate__WEBPACK_IMPORTED_MODULE_0__.getImages)();
        case 8:
          image = _context.sent;
          ...
          dataDisplay = displayCategories === null || displayCategories === void 0 ? void 0 : displayCategories.map(function (object) {
            var color = object.color,
              name = object.name,
              score_out_of_10 = object.score_out_of_10;
            return "<div id=\"display-data22\">\n     <div class=\"row\">\n       <div class=\"col\">\n       ".concat(color, "\n       </div>\n       <div class=\"col\">\n       ").concat(name, "\n       </div>\n       <div class=\"col\">\n       ").concat(score_out_of_10, "\n       </div>\n     </div>\n   </div>");
          }).join(''); // search.addEventListener('click', () => displayInfo(search.value))
          okok.innerHTML = "".concat(responseSummary);
          ok2.innerHTML = "".concat(dataDisplay);
          foto.src = "".concat(image);
        case 13:
        case "end":
          return _context.stop();
      }
...
/******/ })()
;
//# sourceMappingURL=bundle37b441b9864489fd45fa.js.map