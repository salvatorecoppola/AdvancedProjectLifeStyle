    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(apiUrbanAreas);
        case 3:
          response = _context.sent;
          arrayCity = response.data["_links"]["ua:item"]; //Array of objects
          arrayCity = arrayCity.map(function (city) {
            return city.name;
          }); //list of all cities in array
          _context.next = 11;
          break;
        case 8:
          _context.prev = 8;
...
function autocompleteMatch(value) {
  ...
  return arrayCity.filter(function (city) {
